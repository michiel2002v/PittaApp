...
description: 'Generate a complete AGENTS.md file for a repository. Use when user wants to create an AGENTS.md, generate a README for coding agents, document build/test commands for AI tools, or provide coding agents with project-specific context and instructions.'
---
trig: create-agentsmd·agents-md·agent-readme·coding-agent-context
in: codebase·project-structure
