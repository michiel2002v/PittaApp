---
name: ef-core
description: 'Best practices for Entity Framework Core. Use when designing DbContext, configuring entity relationships, writing LINQ queries, managing migrations, handling concurrency, optimizing EF Core performance, or reviewing EF Core code for N+1 issues and security.'
---
trig: efcore·entity-framework·dbcontext·migration·linq·asnotracking·include·changetracking
in: csharp-code·ef-core-code
