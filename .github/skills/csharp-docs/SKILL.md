---
name: csharp-docs
description: 'Ensure C# types are documented with XML comments following best practices. Use when adding or reviewing XML documentation comments on public/internal members, writing summary/remarks/param/returns tags, or auditing C# code for missing documentation.'
---
trig: xml-docs·xml-comments·csharp-documentation·summary·remarks·param·returns
in: csharp-code
